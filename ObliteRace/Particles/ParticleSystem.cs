...
namespace ObliteRace.Particles
{
    /// <summary>
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        protected ParticleSystem(ObliteRaceGame game, int howManyEffects)
            : base(game)
        {            
            this.game = game;
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                ObliteRaceGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity = 
                ObliteRaceGame.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration = 
                ObliteRaceGame.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                ObliteRaceGame.RandomBetween(minLifetime, maxLifetime);
            float scale =
                ObliteRaceGame.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                ObliteRaceGame.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = ObliteRaceGame.RandomBetween(0, MathHelper.TwoPi);
        ...
        /// <summary>
        /// overriden from DrawableGameComponent, Draw will use ObliteRaceGame's 
